...
namespace AGS2Client
{
    ...
    public:
        ...
        virtual bool IsOnSteamDeck() const = 0;
        virtual bool IsTextDismissed() const = 0;
    ...
    AGS2CLIENT_EXPORT int AGS2Client_IsOnSteamDeck() noexcept;
    AGS2CLIENT_EXPORT int AGS2Client_IsTextDismissed() noexcept;
